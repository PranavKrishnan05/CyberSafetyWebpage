...
export const blog = [
  {
    ...
    fulldesc: "How to create a strong password? Never use personal information! it makes your password easy to guess Use a longer password. A strong password should be longer than 6 characters  Use unique Passwords, If you use the same password for every account and someone gets ahold of one of them they have access to all your accounts! Use special characters such as** numbers, symbols, and a mix of upper and lowercase <br> If you're having trouble creating a suitable password a random one is your best bet! You can use a password generator such as lastpass or any other trusted online password generator",
    category: "Passwords",
  ...
  {
    id: 3,
    title: "START YOU CUP ON TABLE OF THAT Click Here to read more!",
